...
#define WIFI_PASSWORD "mnbvc1234"
...
void loop(){
  if (Firebase.ready() && signupOK && (millis() - sendDataPrevMillis > 15000 || sendDataPrevMillis == 0)){
    ...
    //Sending MPU DATA
    //Sending Acc_X
    if (Firebase.RTDB.setFloat(&fbdo, "Data/ACC_X/", random(1,100))){
      Serial.println("PASSED");
      Serial.println("PATH: " + fbdo.dataPath());
      Serial.println("TYPE: " + fbdo.dataType());
    }
    ...
    //Sending MPU DATA
    //Sending Acc_Y
    if (Firebase.RTDB.setFloat(&fbdo, "Data/ACC_Y/", random(1,100))){
      Serial.println("PASSED");
      Serial.println("PATH: " + fbdo.dataPath());
      Serial.println("TYPE: " + fbdo.dataType());
    }
    ...
    //Sending MPU DATA
    //Sending Acc_Z
    if (Firebase.RTDB.setFloat(&fbdo, "Data/ACC_Z/", random(1,100))){
      Serial.println("PASSED");
      Serial.println("PATH: " + fbdo.dataPath());
      Serial.println("TYPE: " + fbdo.dataType());
    }
    ...
    if (Firebase.RTDB.setString(&fbdo, "Data/GPS/", "Random String")){
      Serial.println("PASSED");
      Serial.println("PATH: " + fbdo.dataPath());
      Serial.println("TYPE: " + fbdo.dataType());
    }
